                      ...
                      <tbody>
                        <?php $i=0;$page=0;?>
                          ...
                          <tr>
                              ...
                              <td>
                                <a href="<?php echo site_url('Report/reportUst1/').$row->userStatus_id;?>"><?php echo $row->usttotal;?></a>
                              </td> 
                          </tr>
                          <?php } ?>
                      </tbody>
                      <!-- <tfoot align="right" style="background-color: #E8E8E9">
                        <tr>
                          <td colspan="2">รวมทั้งหมด = <?php /*echo $STtotal; ?> คน </td>
                          <td>คุณครู = <?php echo $STtotal1; ?> คน <br>นักเรียน = <?php echo $STtotal2; */?> คน </td>
                        </tr>
                      </tfoot> -->
                </table>
                </div>
