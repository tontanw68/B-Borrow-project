            ...
            <div class="col-md-9">
              <div class="card py-3 px-5 mt-10 h-100">  
                ...
                <div class="row">
                    ...
                    <div class="col">
                      <div align="right">
                        <a href="<?php echo site_url('Report/reportRsYearsExp');?>" class="btn btn-info"><i class="fa-solid fa-print"></i></a>
                      </div>
                    </div>
                </div>
                <hr>
                <div class="row">
                  <div class="col-auto">
                  <form action="<?php echo site_url ('Report/reportRsYears2');?>" method="post">
                  <div class="row g-3 align-items-center">
                    <div class="col-auto">
                      <label for="inputPassword6" class="col-form-label">ปี</label>
                    </div>
                    <div class="col-auto">
                      <input type="text" id="rsYears" name="rsYears" class="form-contror" value="" required>
                    </div>
                    <div class="col-auto">
                ...
                <?php 
                    $k = $this->input->post('rsYears');
                    if($k != ''){?>
                        <p class="fs-5">ผลการค้นหา"
                        <?php $key = $this->input->post('rsYears');
                        echo $key;?> "</p>
                    <?php }else{
                        echo "";
                    }?>
