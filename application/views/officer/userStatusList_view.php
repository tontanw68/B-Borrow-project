                  ...
                  <div class="justify-content-between">
                    <div class="container"> -->
                      ...
                      <div class="row">
                        ...
                        <div class="col">
                          <div align="right">
                            <a class="btn btn-primary" href="<?php echo site_url('UserStatusdata');?>" role="button"><i class="fa-solid fa-circle-plus" style="font-size:25px"></i></a>
                          </div>
                        </div>
                      </div>
                    <!-- </div>
                ...
                <table id="myTable" class="table table-striped table-bordered">
                      ...
                      <tbody>
                          ...
                          <tr>
                              ...
                              <td><a class="btn btn-warning" href="<?php echo site_Url('UserStatusdata/editUserStatus/').$row->userStatus_id;?>"><i class="fa-solid fa-pen-to-square"></i></a></td>
                          </tr>
                          <?php } ?>
                      </tbody>
