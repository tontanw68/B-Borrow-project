...
header("Content-Disposition: attachment; filename=รายงานข้อมูลค่าปรับตามเดือน.xls");
              ...
              <div class="card py-3 px-5 mt-10 h-100">  
                ...
                <div class="row">
                    <div class="col">
                        ...
                        <p class="fs-6">รายงานข้อมูลค่าปรับตามเดือน ปี พ.ศ. <?php $date = date("Y",strtotime("now")); echo $datenew = $date + 543;?></p>
