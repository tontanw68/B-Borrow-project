                      ...
                      <div class="row">
                        ...
                        <div class="col">
                          <div align="right">
                            ...
                            <a class="btn btn-primary" href="<?php echo site_url('Autocompletedata/booknow');?>" role="button"><i class="fa-solid fa-circle-plus" style="font-size:25px"></i></a>
                            <a class="btn btn-primary" href="<?php echo site_url('Insertdata/index3');?>" role="button">upload file</a>
                          </div>
                        </div>
                      </div>
                    <!-- </div> -->
