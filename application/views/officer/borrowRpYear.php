          ...
          <?php include('officerMenu.php');?>
            <div class="col-md-9">
              <div class="card py-3 px-5 mt-10 h-100">  
                ...
                <div class="row">
                    <div class="col">
                        <h2>รายงานการยืมตามปี</h2>
                    </div>
                    <div class="col">
                      <div align="right">
                        <a href="<?php echo site_url('Report/reportBrYearExp');?>" class="btn btn-info"><i class="fa-solid fa-print"></i></a>
                      </div>
                    </div>
                </div>
                <hr>
                <div class="row">
                  <div class="col-auto">
                  <form action="<?php echo site_url ('Report/reportBrYear2');?>" method="post">
                  <div class="row g-3 align-items-center">
                    ...
                    <div class="col-auto">
                      ...
                      <input type="text" id="brYears" name="brYear" class="form-contror" value="" required>
                    </div>
                    <div class="col-auto">
                ...
                <?php 
                    $k = $this->input->post('brYear');
                    if($k != ''){?>
                        <p class="fs-5">ผลการค้นหา"
                        <?php $key = $this->input->post('brYear');
                      ...
                      <tbody>
                        ...
                        ?>
                          ...
                          <tr>
                              ...
                              <td><?php echo $row->brY;?></td> 
                              <td><?php echo $row->brYeartotal." รายการ"; ?></td>
                              <!-- echo $brYTT1; -->
                              <td><?php echo $row->ex1." รายการ"; ?></td> 
                              <!-- echo $brYTT2; -->
                              <td><?php echo $row->ex." รายการ"; ?></td>
                              <!-- <td></td>
                              <td></td> -->
                          </tr>
                          <?php } ?>
