...
header("Content-Disposition: attachment; filename=รายงานหนังสือตามประเภทหนังสือ.xls");
              ...
              <div class="card py-3 px-5 mt-10 h-100">  
                ...
                <div class="row">
                    <div class="col">
                        ...
                        <p class="fs-6">รายงานหนังสือตามประเภทหนังสือ ปี พ.ศ. <?php $date = date("Y",strtotime("now")); echo $datenew = $date + 543;?></p>
                ...
                <?php foreach ($query as $row){ 
                  echo "ประเภทหนังสือ ".$row->bookType_name." ".$row->bttotal." เล่ม<br>";
                } ?>
                </div>
                <!-- <div class="row">
