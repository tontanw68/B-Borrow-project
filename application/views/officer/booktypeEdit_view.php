    ...
    <div class="container font">   
      <?php include('officerNavbar.php');?>  
            ...
            <div class="col-md-9">
              <div class="card py-3 px-5 mt-10 h-100">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-2">
                    <input type="text" class="form-control" id="" name="bookType_id" value="<?php echo $query->bookType_id;?>" readonly>
                  ...
                  <div class="mb-3 row">
                    ...
                    <input type='hidden' id='bookType_namedata' value='<?php echo json_encode($ofbookType);?>' />
                  ...
                  <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                    <a class="btn btn-warning" href="<?php echo site_url('Showdata/booktypeShow');?>" role="button">ยกเลิก</a>
        ...
        var ofbookType = 
            ...
            ofbookType = JSON.parse(ofbookType);
