          ...
          <?php include('officerMenu.php');?>
            <div class="col-md-9">
              <div class="card py-3 px-5 mt-10 h-100">  
                ...
                <hr>
                <div class="row">
                  <form action="<?php echo site_url ('Report/reportRsTime');?>" method="post">
                  <div class="row g-3 align-items-center">
                    <div class="col-auto">
                      <label for="inputPassword6" class="col-form-label">วันเริ่ม</label>
                    </div>
                    <div class="col-auto">
                      <input type="date" id="" name="rs_ds" class="form-contror" require>
                    </div>
                    <div class="col-auto">
                      <label for="inputPassword6" class="col-form-label">วันสิ้นสุด</label>
                    </div>
                    <div class="col-auto">
                      <input type="date" id="" name="rs_de" class="form-contror" require>
                    </div>
                    <div class="col-auto">
                  ...
                  <?php 
                    $k = $this->input->post('rs_ds');
                    if($k != ''){?>
                        <p class="fs-5">ผลการค้นหา ตั้งแต่วันที่"
                        <?php $key1 = $this->input->post('rs_ds');
                        $key2 = $this->input->post('rs_de');
                ...
                <table id="myTable" class="table table-striped table-bordered">
                      <thead style="background-color: darkgray;">
                          <tr>
                              ...
                              <th>วันที่จอง</th>
                              <th>วันที่นัดรับ</th>
                              <th>ชื่อ-นามสกุล ผู้ใช้</th>
                              <th>ชื่อหนังสือ</th>
                              <th style ="width: 2%">อนุมัติ</th>
