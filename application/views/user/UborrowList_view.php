            ...
            <div class="col-md-12">
              ...
              <div class="row">
                ...
                <!-- <div class="container"> -->
                  ...
                  <hr><br>
                <!-- </div> -->
                <?php echo $_SESSION['name'].' '.$_SESSION['surename'];?><br>
                <table class="table table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <th><?php echo date('d/m/Y',strtotime($row->borrowDay))?></th>
                            <th><?php echo $row->returnDay.'<br>'.$row->officer_return; ?></th>
                            <th><?php echo $row->borrowStatus; ?></th>
