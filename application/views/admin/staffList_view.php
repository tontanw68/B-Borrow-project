...
<body>
    <div class="container font"> 
      <?php include('adminNavbar.php');?>    
            ...
            <div class="col-md-9">
              <div class="card py-3 px-5 mt-10 h-100">  
                ...
                <div class="row">
                  ...
                  <div class="col-md-3">
                    <div align="right">
                      <a class="btn btn-primary" href="<?php echo site_url('Staffdata/index1');?>" role="button"><i class="fa-solid fa-circle-plus" style="font-size:25px"></i></a>
                    </div>
                  </div>
                </div>
                  ...
                  <hr>
                <!-- </div> -->
              <table id="staffW" class="table table-striped table-bordered">
                      <thead style="background-color: darkgray;">
                          <tr>
                              <th style ="width: 2%">No.</th>
                              <th style ="width: 10%">ชื่อ-นามสกุล</th>
                              <th style ="width: 10%">รายละเอียดงาน</th>
        ...
        <script>
          let table = new DataTable('#staffW');
        </script>
