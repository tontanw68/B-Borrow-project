...
<body>
    ...
    <div class="row">
      ...
      <div class="col-md-9">
        <div class="card py-3 px-5 mt-10 h-100">
          ...
          <div class="row">
            <div class="col">
              <h2>เพิ่มรายละเอียดข้อมูลค่าปรับ</h2>
            </div>
          </div>
          <hr>
          <form action="<?php echo site_url('FineTypedata/addfine'); ?>" method="post">
            <div class="mb-3 row">
              ...
              <div class="col-sm-8">
                ...
                <input type='hidden' id='fineTypedata' value='<?php echo json_encode($adfineType);?>' />
            ...
            <div class="mb-3 row">
              ...
              <div class="col-sm-2">
                ...
                <input type='hidden' id='fineRatedata' value='<?php echo json_encode($adfineRate);?>' />
            ...
            <div class="mb-3 row">
              ...
              <div class="col-sm-10">
                <a class="btn btn-warning" href="<?php echo site_url('Showdata/fineShow'); ?>" role="button">ยกเลิก</a>
  ...
  <script>
    $(function() {
      var adfineType = $("#fineTypedata").val();
      adfineType = JSON.parse(adfineType);
      $("#fineType").autocomplete({
        source: adfineType
      });

      var adfineRate = $("#fineRatedata").val();
      adfineRate = JSON.parse(adfineRate);
