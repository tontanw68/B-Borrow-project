          ...
          <?php include('adminMenu.php');?>
            <div class="col-md-9">
              <div class="card py-3 px-5 mt-10 h-100">  
                ...
                <div class="row">
                    <div class="col">
                        <h2>รายงานตารางงานเจ้าหน้าที่ตามช่วงเวลา</h2>
                    </div>
                </div>
                <hr>
                <div class="row text-center">
                  <form action="<?php echo site_url ('Report/reportStTimeAdmin');?>" method="post">
                  <div class="row g-3 align-items-center">
                    <div class="col-auto">
                      <label for="inputPassword6" class="col-form-label">วันเริ่ม</label>
                    </div>
                    <div class="col-auto">
                      <input type="date" id="" name="st_ds" class="form-contror" value="" require>
                    </div>
                    <div class="col-auto">
                      <label for="inputPassword6" class="col-form-label">วันสิ้นสุด</label>
                    </div>
                    <div class="col-auto">
                      <input type="date" id="" name="st_de" class="form-contror" require>
                    </div>
                    <div class="col-auto">
