...
header("Content-Disposition: attachment; filename=รายงานข้อมูลผู้ใช้ตามประเภท.xls");
          ...
          <?php //include('adminMenu.php');?>
            <div class="col-md-9">
              <div class="card py-3 px-5 mt-10 h-100">  
                ...
                <div class="row">
                    <div class="col-md-8">
                        <p class="fs-6">รายงานข้อมูลผู้ใช้ตามประเภท ปี พ.ศ. <?php $date = date("Y",strtotime("now")); echo $datenew = $date + 543;?></p>
                ...
                <?php foreach ($query as $rw) {
                    echo "ประเภทผู้ใช้ ".$rw->type." ".$rw->utypetotal." คน<br>";
                } ?>
                </div>
              </div>
            </div>
