        ...
        <div class="card py-3 px-5 mt-10 h-100">
          <div class="container">
            <!-- <div class="row"> -->
              <!-- <div class="col-9"> -->
                <!-- <h1>menu</h1> -->
                <!-- <p class="fs-2">รายละเอียดงานเจ้าหน้าที่</p> -->
                <div class="row">
                    <div class="col">
                        <h2>รายละเอียดข้อมูลตารางงานเจ้าหน้าที่</h2>
                    </div>
                    <div class="col-md-3">
                        <div align="right">
                        <a class="btn btn-primary" href="<?php echo site_url('Staffdata/wdInsert');?>" role="button"><i class="fa-solid fa-circle-plus" style="font-size:25px"></i></a>
                        </div>
                    </div>
                </div>
              ...
              <tbody>
                ...
                <?php foreach ($query as $row) { ?>
                  <tr>
                    ...
                    <td><a class="btn btn-warning" href="<?php echo site_Url('Staffdata/wdEdit/') . $row->WorkDetails_id; ?>"><i class="fa-solid fa-pen-to-square"></i></a></td>
                  </tr>
                <?php } ?>
              </tbody>
